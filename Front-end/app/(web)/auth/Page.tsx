...
const Auth = () => {
    ...
    const inputStyles = "border border-gray-300 rounded-md sm:text-sm text-black rounded-lg block w-full p-2.5 focus:outline-none";
  ...
  return (
    <section className="container mx-auto">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8 w-80 md:w-[70%] mx-auto ">
            <div className="flex mb-8 flex-column md:flex-row justify-between">
